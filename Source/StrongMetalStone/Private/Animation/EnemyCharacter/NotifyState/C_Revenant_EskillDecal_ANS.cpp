...
#include "Animation/EnemyCharacter/NotifyState/C_Revenant_EskillDecal_ANS.h"
...
void UC_Revenant_EskillDecal_ANS::NotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, float TotalDuration)
{
	...
	TargetWorldRot = FRotator(WorldRot.Pitch, WorldRot.Yaw , WorldRot.Roll);
	...
	FRotator SpawnRotation = FRotator::ZeroRotator;
		...
		SpawnRotation = FRotator(WorldRot.Pitch, WorldRot.Yaw + 180.0f, WorldRot.Roll);
...
void UC_Revenant_EskillDecal_ANS::NotifyTick(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, float FrameDeltaTime)
{
...
void UC_Revenant_EskillDecal_ANS::NotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
